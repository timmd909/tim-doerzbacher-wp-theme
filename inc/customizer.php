 ...
 */
function tim_doerzbacher_wp_theme_customize( $wp_customize ) {
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'header_logo', array(
		'label'       => __( 'Upload Header Logo', 'tim-doerzbacher-wp-theme' ),
		'description' => __( 'Height: &gt;80px', 'tim-doerzbacher-wp-theme' ),
	...
	$wp_customize->add_control( 'navbar_scheme', array(
		'type'     => 'radio',
		'label'    => __( 'Navbar Scheme', 'tim-doerzbacher-wp-theme' ),
		'section'  => 'theme_header_section',
		'choices'  => array(
	...
	$wp_customize->add_control( 'navbar_position', array(
		'type'     => 'radio',
		'label'    => __( 'Navbar', 'tim-doerzbacher-wp-theme' ),
		'section'  => 'theme_header_section',
		'choices'  => array(
						'static'       => __( 'Static', 'tim-doerzbacher-wp-theme' ),
						'fixed_top'    => __( 'Fixed to top', 'tim-doerzbacher-wp-theme' ),
						'fixed_bottom' => __( 'Fixed to bottom', 'tim-doerzbacher-wp-theme' ),
					),
	...
	$wp_customize->add_control( 'search_enabled', array(
		'type'     => 'checkbox',
		'label'    => __( 'Show Searchfield?', 'tim-doerzbacher-wp-theme' ),
		'section'  => 'theme_header_section',
		'settings' => 'search_enabled',
		'priority' => 3,
	) );
}
add_action( 'customize_register', 'tim_doerzbacher_wp_theme_customize' );
